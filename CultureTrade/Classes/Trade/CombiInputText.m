...
-(CGRect)textRectForBounds:(CGRect)bounds
{
    ...
    CGRect inset = CGRectMake(bounds.origin.x+100, bounds.origin.y, bounds.size.width -150, bounds.size.height);//更好理解些
...
-(CGRect)editingRectForBounds:(CGRect)bounds
{
    ...
    CGRect inset = CGRectMake(bounds.origin.x +100, bounds.origin.y, bounds.size.width -150, bounds.size.height);
    return inset;
}
