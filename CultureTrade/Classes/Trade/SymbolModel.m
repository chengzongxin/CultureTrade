...
- (SymbolModel *)initWithDictionary:(NSDictionary *)dict
{
    ...
    symbol.productID =      [dict objectForKey:INT2STRING(FIX_TAG_BODY_SECURITYID)];//48
    symbol.productName =    [dict objectForKey:INT2STRING(FIX_TAG_INTPRTCL_PRODUCTNAME)];//9402
    symbol.singlePrice =    [dict objectForKey:INT2STRING(FIX_TAG_INTPRTCL_SINGLEPRICE)];//dict[@"9605"];
    symbol.totalVolume =    [dict objectForKey:INT2STRING(FIX_TAG_BODY_SECURITYTOTALVOLUME)];//dict[@"53"];
    ...
    symbol.minimumAsk =     [dict objectForKey:INT2STRING(FIX_TAG_BODY_MINQTY)];//dict[@"110"];
    symbol.maxnumAsk =      [dict objectForKey:INT2STRING(FIX_TAG_BODY_MAXQTY)];//dict[@"111"];
    ...
    symbol.publicDate =     [dict objectForKey:INT2STRING(FIX_TAG_BODY_PUBLICDATE)];//dict[@"59"];
    symbol.destoryDate =    [dict objectForKey:INT2STRING(FIX_TAG_BODY_ENDDATE)];//dict[@"432"];
