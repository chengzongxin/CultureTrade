...
NSString *const TOGGLE_BUTTON_IMAGE      = @"on_cir";
NSString *const TOGGLE_BASE_IMAGE        = @"off_bg";
NSString *const TOGGLE_VIEW_BACKGROUND   = @"off_bg";
NSString *const LEFT_BUTTON_IMAGE        = @"off_cir";
NSString *const LEFT_BUTTON_IMAGE_SEL    = @"off_cir";
NSString *const RIGHT_BUTTON_IMAGE       = @"on_cir";
NSString *const RIGHT_BUTTON_IMAGE_SEL   = @"on_cir";
